...
namespace DIO.Series
{
    class Program
    {
        static Dio.Series.SerieRepositorio repositorio = new Dio.Series.SerieRepositorio();
        ...
        {
            Console.Write("Digite o id da série");
            int indiceSerie = int.Parde(Console.ReadLine());
            ...
            respositorio.Atualiza(indiceSerie, atualizaSerie);
        }
        ...
        private static void InserirSerie()
        {
            ...
            genero: (Genero)entradaGenero, titulo: entradaTitulo, ano: entradaAno, 
